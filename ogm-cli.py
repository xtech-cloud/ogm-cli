...
print("****************************************************")
print("* OpenGM Client Tool - ver 3.3.0")
print("****************************************************")
...
print("4. generate the msa")
print("5. generate the module")
...
if "1" == index:
    ...
    if "" == proto_dir:
        print("!!! proto dir is required")
        sys.exit(0)
    from generator import msa 
    msa.create_go_sln(org_name, service_name, proto_dir)
elif "5" == index:
    org_name = input("enter organization name (default ogm):")
    if "" == org_name:
        org_name = "ogm"
